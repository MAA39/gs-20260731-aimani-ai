...
export const relationshipTodoPathSchema=z.object({organizationId:z.string().min(1),contextMembershipId:z.string().min(1)});
...
export const relationshipTodoWorkspaceSchema=z.object({organization:z.object({organizationId:z.string(),name:z.string()}),currentMember:todoMemberSummarySchema,contextMember:memberSummarySchema,todos:z.array(todoSummarySchema)});
export type TodoSummary=z.infer<typeof todoSummarySchema>; export type RelationshipTodoWorkspace=z.infer<typeof relationshipTodoWorkspaceSchema>;
