...
export type OrganizationMembershipResult = { status: 'ok'; organizations: OrganizationMembershipSummary[] } | { status: 'error'; error: { code: 'service_unavailable'; message: string } };
