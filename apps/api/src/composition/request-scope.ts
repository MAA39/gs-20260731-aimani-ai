...
export interface RequestCradle extends RootCradle {
  env: ApiBindings;
  request: Request;
  healthCheck: HealthCheck; todoRepository: Promise<TodoRepository>; createSharedTodo: Promise<CreateSharedTodo>; getSharedTodoWorkspace: Promise<GetSharedTodoWorkspace>; todoHandoffRepository: Promise<TodoHandoffRepository>; requestTodoHandoff: Promise<RequestTodoHandoff>; acceptTodoHandoff: Promise<AcceptTodoHandoff>; rejectTodoHandoff: Promise<RejectTodoHandoff>; cancelTodoHandoff: Promise<CancelTodoHandoff>; getTodoHandoffWorkspace: Promise<GetTodoHandoffWorkspace>; getAssignedTodoWorkspace: Promise<GetAssignedTodoWorkspace>;
