...
- [ ] **Step 2: Define the seven-table schema**
...
- [ ] **Step 1: Register request-scoped DB resources**
...
- [ ] **Step 2: Mount Better Auth in Hono**
...
- [ ] **Step 3: Add session and organization application flow**
...
- [ ] **Step 4: Seed the touchable identity graph**
...
- [ ] **Step 5: Make the Web proxy canonical**
...
- [ ] **Step 4: Add the thin Start Server Function**
...
- [ ] **Step 1: Build Login without effect-driven fetching**
...
- [ ] **Step 2: Build Organization chooser**
...
- [ ] **Step 3: Replace the mock People home**
