...
- [ ] **Step 3: helperを実装し、compositionから使う**
...
- [ ] **Step 4: private `AssignedCard` を専用ファイルへ移す**
...
- [ ] **Step 3: TodayPageを3主区分とrecent補助区分で構成する**
...
- [ ] **Step 1: pure copy expectationを先にtestへ加える**
